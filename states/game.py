...
class Game(State):
    ...
    def next_level(self):
        ...
        if self.level >= len(self.levels):
            self.level = 0
        self.softbody.load_model(self.levels[self.level], (self.manager.SCREEN_C[0], round(self.manager.SCREEN_C[1] / 1.5)))

    def load_level(self, level):
        self.softbody.load_model(self.levels[level], (self.manager.SCREEN_C[0], round(self.manager.SCREEN_C[1] / 1.5)))
